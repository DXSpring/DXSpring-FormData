...
// Object Provider
export const ObjectProvider = ({ data, key }: IObjectProvider): any => {
    const FinalData: any = {};
    ...
    if (data && !!Object.keys(data).length) {
        for (let Index = 0; Index < Object.keys(data).length; Index++) {
            ...
            if (data[Object.keys(data)[Index]] instanceof Object && !(data[Object.keys(data)[Index]] instanceof Array) && !!Object.keys(data[Object.keys(data)[Index]]).length) {
                const ObjectData = ObjectService({ data: data[Object.keys(data)[Index]], key: `${key ? key + '[' : ''}${Object.keys(data)[Index]}${key ? ']' : ''}` });
